...
## Table of Contents
+ [Communications & Networking](#communications-and-networking) (-> work in progress)
...
- **Introduction to Communications & Networks**
  - _Introduction to Computer Networks_ (2020)
    - 1 An overview of Networks:
      ...
      - 1.15 IETF and OSI
    - 4 Wireless LANs:
      - 4.2 Wi-Fi (just the introduction, 4.2.1 onward is optional)
    - 5 Other LANs:
  ...
  - _Computer Networks_ (2011)
    - 1 Introduction:
      - 1.3 Network software
  - [Connection-oriented and Connectionless services](https://everything2.com/index.pl?node_id=1409718)

- **The Physical layer**
  - _Computer Networks_ (2011)
    - 2 The physical layer:
      - 2.1 The theoretical basis for data communication (2.1.1 and 2.1.2 optional)
      - 2.4 Communication satellites (optional)
      - 2.5 Digital modulation and multiplexing (2.5.5 optional)
  - _Introduction to Computer Networks_ (2020)
    - 2 Ethernet basics:
      - 2.1 10-Mbps classic Ethernet (2.1.11.1 and 2.1.11.2 optional)
      - 2.2 100 Mgps (fast) Ethernet
      - 2.3 Gigabit Ethernet
      - 2.4 Ethernet switches
      - 2.5 Epilog
      - 2.6 Exercises <<<<<< 2.1-2.4 & 3.1-3.4 ?

- **The Data Link layer**
  - _Computer Networks_ (2011)
    - 2 The physical layer:
      - 2.6 The public switched telephone network (just the introduction and 2.6.1. Optional: 2.6.2, 2.6.3, 2.6.4, 2.6.5)
      - 2.7 The mobile telephone system
      - 2.8 Cable television (optional)
  - _Introduction to Computer Networks_ (2020)
    - 3 :
      - 3.6 
      - 3.7 
...
- **The Network layer**
  -**IPv4 and IPv6**
    - _Computer Networks_ (2011)
      - 2 The physical layer:
        - 2.1 Theoretical basis for data communications (optional: 2.1.1 and 2.1.2)
        - 2.4 Communication satellites (optional)
        - 2.5 Digital modulation and Multiplexing (optional: 2.5.5)
    - _Introduction to Computer Networks_ (2020)
      - 1 An overview of Networks:
      ...
      - 11 IPv6:
        ...
        - 11.6 Neighbor discovery (11.6.4 optional)
  - **Routing** ---- (13, 14, 15)
    - _Introduction to Computer Networks_ (2020)
      - 9 :
        - Introduction
...
- **The Transport layer** (16)
  -**UDP**
    - _Introduction to Computer Networks_ (2020)
      ...
      - 11 :
        - Introduction
        - 11.1 - 11.6 (optional: 11.1.3 and 11.1.4)
  -**TCP** (17, 18, 19, 20, 21, 22)
    - _Introduction to Computer Networks_ (2020)
      - 12 :
        - Introduction
        - 12.1 - 12.5
        - 12.7 - 12.21
        - Optional: 12.6, 12.22, 12.23
      - 13 :
        - Introduction
        - 13.1 - 13.2
        - Optional: 13.3 - 13.11
...
- **The Application layer and Network security**
  - _Introduction to Computer Networks_ (2020)
    - 3 :
      - Introduction
      - 3.2
      - Optional: 3.1, 3.3, 3.4
    - 22 :
      - Introduction
      - 22.1 - 22.4 (optional: 22.2.2)
      - Optional: 22.5 - 22.12
  
[Communications and Networking (synthesis)](https://github.com/AnselmoGPP/Learn-Computer-Science/blob/master/topics/computer_science/networking/1_communications_and_networking.md)
